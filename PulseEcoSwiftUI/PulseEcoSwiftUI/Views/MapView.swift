...
struct MapView: UIViewRepresentable {
    ...
    func updateUIView(_ uiView: MKMapView, context: Context) {
        let coordinate = CLLocationCoordinate2D(latitude: Double(mapVM.cityModel.cityLocation.latitude)!, longitude: Double(mapVM.cityModel.cityLocation.longitute)!)
        ...
        let pins:[Pin] = mapVM.sensors.map{
            sensor in
        ...
        let zoomRange = MKMapView.CameraZoomRange(maxCenterCoordinateDistance: Double(mapVM.cityModel.intialZoomLevel*1000))//100000)
